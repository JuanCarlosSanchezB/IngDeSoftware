...
public final class UserBinding implements ViewBinding {
  ...
  private UserBinding(@NonNull ConstraintLayout rootView, @NonNull Button Help,
      @NonNull Button logout, @NonNull Button payment, @NonNull ImageView profilepic,
      @NonNull TextView textView, @NonNull LinearLayout userLayout) {
  ...
  public static UserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new UserBinding((ConstraintLayout) rootView, Help, logout, payment, profilepic,
          textView, userLayout);
    }
