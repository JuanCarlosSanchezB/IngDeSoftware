...
public final class ActivityMenuBinding implements ViewBinding {
  ...
  private ActivityMenuBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageButton backFromPayment, @NonNull ImageView imageView,
      @NonNull LinearLayout layoutPrincipal, @NonNull ConstraintLayout main) {
  ...
  public static ActivityMenuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMenuBinding((ConstraintLayout) rootView, backFromPayment, imageView,
